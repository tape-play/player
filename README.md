Media player that works in browser and has some unusual features.

Features:
- Bugs
- Plays all formats that browser supports
- Plays MIDI files using oscillators
- Recording with ability to pause. All audio effects except bass, treble and volume are recorded. SYNC DUB starts recording from start of current track
- Line in/mic. You can connect radio/cassette player/whatever to your computer, listen to it and record as audio file (digitize audio cassettes online without sms and registration). Playing audio file simultaneously is also possible
- 37-band equalizer, with presets support
